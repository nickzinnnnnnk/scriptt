...
local Window = Library.CreateLib("Speed Hub X | Version 1.7.0", "DarkTheme")
...
-- Seções
local HomeSec = Home:NewSection("Status")
local PlayerSec = Player:NewSection("Player Settings")
local FarmSec = Farm:NewSection("Auto Farm")
local MiscSec = Misc:NewSection("Extras")

-- Botões exemplo
FarmSec:NewToggle("Auto Quest", "Faz missões sozinho", function(v)
    _G.AutoQuest = v
end)

FarmSec:NewToggle("Auto Farm", "Mata mobs sozinho", function(v)
    _G.AutoFarm = v
end)

MiscSec:NewButton("Fechar UI", "Fecha o hub", function()
    Library:ToggleUI()
end)
